...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "О платформе — Сборка" },
      {
        name: "description",
        content:
          "Сборка — единое пространство готовых бизнес-решений. Принципы, подход и для кого создана платформа.",
      },
      { property: "og:title", content: "О платформе — Сборка" },
      {
  ...
  return (
    <>
      <PageHero
        ...
        description="Сборка — это платформа, где собственники и руководители выбирают готовые инструменты для роста и порядка в компании. Отдельные решения и комплексные наборы — в одной логике выбора."
      />
